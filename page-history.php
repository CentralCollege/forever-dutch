<?php get_header(); ?>
    ...
    <section class="quadStat">
      <div class="container">
        <div class="one-half column">
          <div class="dateSpan">1920-1969</div>
        </div>
        <div class="one-half column">
          <div class="dateSpan">Since 1970</div>
        </div>
      </div>
      <div class="container">
    ...
    <section class="lightGray dropTop groundBreakingAfter">
      <div class="top container">
        <h2 class="redText"><img src="//192.168.56.111/wp-content/themes/foreverDutch/images/echelon.svg" class="eschelon">The heart of the A.N. Kuyper Athletics Complex and the proud Dutch athletics tradition: P.H. Kuyper Gymnasium.</h2>
    ...
    <section class="comparison exteriorMockAfter">
      <img src="//192.168.56.111/wp-content/themes/foreverDutch/images/comparison.svg" alt="Stat Comparison">
    </section>
    <section class="red">
